...
namespace App\MonsterManual\Infrastructure\Http\Controller;

use App\Form\MonsterForm;
use App\MonsterManual\Application\Command\DeleteMonsterCommand;
...
{
    #[Route('/dm/monster/list', name: 'monster_list', methods: [Request::METHOD_GET])]
    ...
    #[Route('/dm/monster/create', name: 'monster_create', methods: [Request::METHOD_GET, Request::METHOD_POST])]
    ...
    #[Route('/dm/monster/{id}/update', name: 'monster_update', methods: [Request::METHOD_GET, Request::METHOD_POST])]
    ...
    #[Route('/dm/monster/{id}/delete', name: 'monster_delete', methods: [Request::METHOD_GET])]
    ...
    #[Route('/dm/monster/{id}', name: 'monster_read', methods: [Request::METHOD_GET])]
